 ...
 * 
 */
public class MedicinesV2 extends BaseActivity implements ActivityItf,
	...
	private void LoadData() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					obj = orderhelper.GetSimMedicinesBySalerID(saler_id);
...
//						msg.what = HANDLER_GEDATA_FAILD;
	...
	private final class MedicineHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case MedicinesV2.HANDLER_GETDATA_SUCCESS:
				if (msg.obj != null) {
					datas.clear();
			...
			case MedicinesV2.HANDLER_GEDATA_FAILD:
				// datas.clear();
				// adapter.notifyDataSetChanged();
				loading.setVisibility(View.VISIBLE);
				medicine_list.setVisibility(View.GONE);
